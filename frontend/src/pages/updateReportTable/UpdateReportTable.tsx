...
import { UpdateReportGroup } from "./model/UpdateReport";
        ...
        <tbody>
          {updateReportGroups.map((reportGroup, index) => (
            <tr key={index}>
              ...
              <td>
                {updateReportCalcTotal(reportGroup.reportList).totalOwners}
              </td>
              <td>
                {updateReportCalcTotal(reportGroup.reportList).totalAgencies}
              </td>
              <td>{updateReportCalcTotal(reportGroup.reportList).totalReds}</td>
              <td>{updateReportCalcTotal(reportGroup.reportList).total}</td>
            </tr>
          ))}
        </tbody>
      </table>
