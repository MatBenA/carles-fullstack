...
const Settings = () => {
  ...
  const [agencyValidity, setAgencyValidity] = useState<Setting>(emptySetting());
    ...
    const getSettings = async () => {
      try {
        ...
        if (isMounted && result.data) {
          ...
          setStatisticBottomLimit(findSetting("statisticBottomLimit"));
  ...
  return (
    <div className="container">
      <section className="form-custom">
        ...
        <div>
          <label htmlFor="statisticBottomLimit">Bandera inferior</label>
          <div className="dflex gap-30">
            <input
        ...
        <div>
          ...
          <label htmlFor="particularValidity">Vigencia propietarios</label>
          <div className="dflex gap-30">
            <input
        ...
        <div>
          ...
          <div className="dflex gap-30">
            ...
            />
            <button
              onClick={() => handleClick(businessEvaluationCheapFlag)}
              className="green-btn"
            >
              Guardar
            </button>
        ...
        <div>
          ...
          <div className="dflex gap-30">
            ...
            />
            <button
              onClick={() => handleClick(businessEvaluationExpFlag)}
              className="green-btn"
            >
              Guardar
            </button>
