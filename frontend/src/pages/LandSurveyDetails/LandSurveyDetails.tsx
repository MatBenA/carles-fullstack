            ...
            try {
                ...
                if (isMounted && response.data != null) {
                    ...
                    setPriceVerificationDate(
                        new Date(
                            landsurvey.priceVerificationDate && landsurvey.date
                        )
                    );
                    setReassessmentDate(
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="dflex gap-30">
                    <div>
                        ...
                        <div className="dflex gap-30">
                            ...
                            <button
                                type="button"
                                onClick={() =>
                                    setPriceVerificationDate(new Date())
                                }
                            >
                                Hoy
                            </button>
                    ...
                    <div>
                        ...
                        <output>
                            {getDaysSincePrice(priceVerificationDate)}
                        </output>
                    </div>
                </div>
                <div className="dflex gap-30">
                ...
                <div>
                    <label htmlFor="reassessmentDate">
                        Fecha de retasación:
                    </label>
                    <div className="dflex gap-30">
                        <input
                            ...
                            id="reassessmentDate"
                            value={
                                reassessmentDate?.toISOString().split("T")[0]
                            }
                            onChange={(e) =>
                                setReassessmentDate(new Date(e.target.value))
                            }
                        />
                        <button
                            type="button"
